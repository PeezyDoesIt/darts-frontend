...
.submit-btn { flex: 1; position: relative; overflow: hidden; height: clamp(52px, 7dvh, 80px); font-size: clamp(20px, 3.2dvh, 30px); font-weight: 900; letter-spacing: 0.15em; text-transform: uppercase; }
.submit-timer-fill {
