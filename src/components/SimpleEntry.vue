...
.submit-btn { flex: 1; width: 100%; position: relative; overflow: hidden; height: clamp(58px, 7.5dvh, 88px); font-size: clamp(44px, 6.5dvh, 70px); font-weight: 900; letter-spacing: 0.06em; text-transform: uppercase; font-family: var(--font-display); }
.submit-timer-fill {
