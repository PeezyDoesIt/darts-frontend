...
.numpad-footer { width: 100%; display: flex; align-items: stretch; gap: 10px; padding: 8px 12px; padding-bottom: calc(8px + env(safe-area-inset-bottom)); }
...
.submit-btn { flex: 1; width: 100%; position: relative; overflow: hidden; height: clamp(58px, 7.5dvh, 88px); font-size: clamp(50px, 7.2dvh, 78px); font-weight: 900; letter-spacing: 0.08em; text-transform: uppercase; font-family: var(--font-display); }
.submit-timer-fill {
