...
export const PLAYER_THEMES = [
  ...
  { label: 'Onyx',         value: 'linear-gradient(160deg, #000000 0%, #0a0a0a 40%, #141414 70%, #1e1e20 100%)' },
  { label: 'Carbon',       value: 'linear-gradient(160deg, #020408 0%, #080c14 40%, #10161e 70%, #1a2030 100%)' },
  ...
  { label: 'Iron',         value: 'linear-gradient(160deg, #060608 0%, #111318 40%, #222530 70%, #3a3d48 100%)' },
  { label: 'Slate',        value: 'linear-gradient(160deg, #080c12 0%, #141e2a 40%, #243040 70%, #3a4a5e 100%)' },
