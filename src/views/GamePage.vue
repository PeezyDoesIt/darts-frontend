...
@media (orientation: landscape) and (max-height: 900px) {
  ...
  .turn-name { font-size: clamp(28px, 4.5dvh, 42px); }
...
@media (max-width: 768px) {
  ...
  .turn-name { font-size: clamp(36px, 5.5dvh, 58px); max-width: 55vw; }
