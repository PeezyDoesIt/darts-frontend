  ...
  <div class="home">
    ...
    <div class="home-left">
      ...
      <div class="home-actions">
        ...
        <button v-ripple class="btn btn-xl w-full lrc-btn" @click="router.push('/lrc/setup')">
          🎲 LEFT RIGHT CENTER
        </button>
